...
if text == "تحديث السورس 🔱" and is_devtaha(msg) then  storm_sendMsg(msg.chat_id_, msg.id_, 1, '♻ • جاري تحديث السورس • ♻', 1, 'md') os.execute('rm -rf STORM.lua') os.execute('wget https://raw.githubusercontent.com/NOVAR1/STORM/master/STORM.lua') os.execute('wget https://raw.githubusercontent.com/NOVAR1/STORM/master/plugins_/help_rep.lua')  sleep(0.5) storm_sendMsg(msg.chat_id_, msg.id_, 1, '🚸*¦* تم تحديث ♻ السورس ✔ ', 1, 'md') dofile('STORM.lua')  io.popen("rm -rf ~/.telegram-cli/data/audio/*") io.popen("rm -rf ~/.telegram-cli/data/document/*") io.popen("rm -rf ~/.telegram-cli/data/photo/*") io.popen("rm -rf ~/.telegram-cli/data/sticker/*") io.popen("rm -rf ~/.telegram-cli/data/temp/*") io.popen("rm -rf ~/.telegram-cli/data/thumb/*") io.popen("rm -rf ~/.telegram-cli/data/video/*") io.popen("rm -rf ~/.telegram-cli/data/voice/*") io.popen("rm -rf ~/.telegram-cli/data/profile_photo/*") end
...
storm_sendMsg(msg.chat_id_, msg.id_,1, '*📮¦ العضــو » ('..matches[2]..')\n📬¦ لا توجد صوره رقم » ('..matches[4]..') في حسابه *\n',1,'md') 
end 
end 
...
os.execute('wget https://raw.githubusercontent.com/NOVAR1/STORM/master/plugins_/help_rep.lua') 
sleep(0.5) 
